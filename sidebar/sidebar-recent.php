<article id="post-<?php the_ID() ?>" <?php post_class('sidebar-recent p-2') ?>>
	<div class="row">
		...
		<div class="col-12 col-md-6">
			<div class="section">
				<div class="meta-title">
					<?php the_title( sprintf( '<h4><a href="%s" title="'.get_the_title().'">', esc_url( get_permalink() ) ), '</a></h4>' ); ?>
				</div>
				<div class="row no-gutters">
					<div class="meta-time mr-auto small">
						<small><?php the_time( 'F j, Y' ) ?></small>
					</div>
					<div class="meta-commen mr-auto small">
						<small><?php echo '<span class=""><i class="fa fa-comments text-secondary" style="font-size:10px"></i></span>' . ' ' . comment_count() ?></small>
					</div>		
					<div class="meta-author mr-auto small">
